...
interface RecreationsSummaryCardProps {
  onClick: () => void;
}

const RecreationsSummaryCard: React.FC<RecreationsSummaryCardProps> = ({ onClick }) => {
  return (
    <motion.div
    ...
    >
      <button 
        onClick={onClick} 
        className="group relative block w-full text-left overflow-hidden rounded-2xl bg-surface/50 dark:bg-surface/10 border border-border/50 h-full focus:outline-none focus:ring-2 focus:ring-brand-accent/50"
      >
        <div className="relative aspect-[16/10] overflow-hidden bg-black">
          <img
            src="https://i.imgur.com/wij6Im5.jpeg"
            alt="Recreaciones de Películas"
...
export default RecreationsSummaryCard;